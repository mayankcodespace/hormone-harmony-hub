        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Men's hormonal health information is often dominated by bro-science, supplement marketing, 
              and fear-mongering. We believe men deserve better — clear explanations in simple language, 
              rooted in evidence, without the hype.
            </p>
            <p className="text-muted-foreground mt-4">
              Our goal is to help you understand your body, recognize patterns worth paying attention to, 
              and know when to seek professional care — all without making you panic or pushing unnecessary products.
            </p>
          </section>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="rounded-lg border border-border p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Every piece of content is reviewed for accuracy and based on 
                  reputable medical sources, not marketing claims.
                </p>
              </div>
              <div className="rounded-lg border border-border p-4">
                <h3 className="font-semibold mb-2">No Bro-Science</h3>
                <p className="text-sm text-muted-foreground">
                  We present information factually. No exaggerated claims, no miracle cures, 
                  no "hacks" that sound too good to be true.
                </p>
              </div>
              <div className="rounded-lg border border-border p-4">
                <h3 className="font-semibold mb-2">India-Relevant</h3>
                <p className="text-sm text-muted-foreground">
                  Content written with Indian men in mind — Indian food examples, 
                  local healthcare context, and practical advice.
                </p>
              </div>
              <div className="rounded-lg border border-border p-4">
          ...
          <section>
            ...
            <ul className="space-y-3 text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <span className="text-primary">•</span>
                We cite evidence-based sources (medical journals, WHO, peer-reviewed research)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary">•</span>
                We include mental health resources where relevant
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary">•</span>
                We don't promote supplements or products
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Hormone Clarity for Men was created by a team passionate about health education. 
              Our content is researched and written with care, reviewed for medical accuracy, 
              and designed to be accessible to busy men who just want straight answers.
            </p>
            <p className="text-muted-foreground mt-4">
